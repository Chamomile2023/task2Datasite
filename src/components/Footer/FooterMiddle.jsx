        ...
        <div className="container">
          <div className="footer__middle__hero">
            ...
            <ul className="footer__middle__list">
              ...
              <li className="footer__middle--item">
                <NavLink to="" className="footer__middle--navlink">
                  <i className="fa-solid fa-location-dot footer__middle--icon"></i>
                  Ukraine, Kyiv,Khreshchatyk 1
                </NavLink>
              </li>
              <li className="footer__middle--item">
                <NavLink to="" className="footer__middle--navlink">
                  <i className="fa-regular fa-phone footer__middle--icon"></i>
                  +38 (050) 12 34 567
                </NavLink>
              </li>
              <li className="footer__middle--item">
                <NavLink to="" className="footer__middle--navlink">
                  <i className="fa-solid fa-clock footer__middle--icon"></i>
                  All week 24/7
                </NavLink>
              </li>
              <li className="footer__middle--item">
                <NavLink to="" className="footer__middle--navlink">
                  <i className="fa-regular fa-envelope footer__middle--icon"></i>
